...
then
	...
	then
		...
		AC_MSG_CHECKING(for EVP_PKEY_get0_RSA)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_PKEY_get0_RSA(0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_PKEY_GET0_RSA,1,SSL has EVP_PKEY_get0_RSA) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_PKEY_get0_DSA)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_PKEY_get0_DSA(0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_PKEY_GET0_DSA,1,SSL has EVP_PKEY_get0_DSA) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_PKEY_get0_EC_KEY)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_PKEY_get0_EC_KEY(0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_PKEY_GET0_EC_KEY,1,SSL has EVP_PKEY_get0_EC_KEY) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_PKEY_get1_RSA)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_PKEY_get1_RSA(0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_PKEY_GET1_RSA,1,SSL has EVP_PKEY_get1_RSA) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_PKEY_get1_DSA)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_PKEY_get1_DSA(0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_PKEY_GET1_DSA,1,SSL has EVP_PKEY_get1_DSA) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_PKEY_get1_EC_KEY)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_PKEY_get1_EC_KEY(0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_PKEY_GET1_EC_KEY,1,SSL has EVP_PKEY_get1_EC_KEY) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])
		...
		AC_MSG_CHECKING(for SHA512_CTX)
		FW_TRY_LINK([#include <openssl/sha.h>],[SHA512_CTX c;],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_SHA512_CTX,1,SSL has SHA512_CTX) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for PKCS5_PBKDF2_HMAC)
		FW_TRY_LINK([#include <openssl/evp.h>],[PKCS5_PBKDF2_HMAC(0,0,0,0,0,0,0,0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_PKCS5_PBKDF2_HMAC,1,SSL has generic PKCS5_PBKDF2_HMAC) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for PKCS5_PBKDF2_HMAC_SHA1)
		FW_TRY_LINK([#include <openssl/evp.h>],[PKCS5_PBKDF2_HMAC_SHA1(0,0,0,0,0,0,0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_PKCS5_PBKDF2_HMAC_SHA1,1,SSL has PKCS5_PBKDF2_HMAC_SHA1) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for DH_set0_pqg)
		FW_TRY_LINK([#include <openssl/dh.h>],[DH_set0_pqg((DH *)0,(BIGNUM *)0,(BIGNUM *)0,(BIGNUM *)0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_DH_SET0_PQG,1,SSL has DH_set0_pqg) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])
		...
		AC_MSG_CHECKING(for DES_ecb_encrypt)
		FW_TRY_LINK([#include <openssl/des.h>],[DES_key_schedule s; DES_set_key_unchecked((const_DES_cblock *)0,&s); DES_ecb_encrypt((const_DES_cblock *)0,(DES_cblock *)0,&s,DES_ENCRYPT);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_DES_ECB_ENCRYPT,1,SSL has DES_ecb_encrypt) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])
		...
		AC_MSG_CHECKING(for EVP_aes_128_cfb1)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_128_cfb1();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_128_CFB1,1,SSL has EVP_AES_128_CFB1) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_128_cfb8)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_128_cfb8();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_128_CFB8,1,SSL has EVP_AES_128_CFB8) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_128_cfb128)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_128_cfb128();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_128_CFB128,1,SSL has EVP_AES_128_CFB128) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_128_ecb)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_128_ecb();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_128_ECB,1,SSL has EVP_AES_128_ECB) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_128_ofb)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_128_ofb();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_128_OFB,1,SSL has EVP_AES_128_OFB) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_128_gcm)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_128_gcm();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_128_GCM,1,SSL has EVP_AES_128_GCM) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_128_ccm)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_128_ccm();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_128_CCM,1,SSL has EVP_AES_128_CCM) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_128_ctr)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_128_ctr();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_128_CTR,1,SSL has EVP_AES_128_CTR) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_cbc)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_cbc();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_CBC,1,SSL has EVP_AES_192_CBC) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_cfb1)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_cfb1();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_CFB1,1,SSL has EVP_AES_192_CFB1) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_cfb8)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_cfb8();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_CFB8,1,SSL has EVP_AES_192_CFB8) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_cfb128)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_cfb128();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_CFB128,1,SSL has EVP_AES_192_CFB128) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_ecb)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_ecb();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_ECB,1,SSL has EVP_AES_192_ECB) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_ofb)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_ofb();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_OFB,1,SSL has EVP_AES_192_OFB) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_gcm)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_gcm();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_GCM,1,SSL has EVP_AES_192_GCM) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_ccm)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_ccm();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_CCM,1,SSL has EVP_AES_192_CCM) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_192_ctr)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_192_ctr();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_192_CTR,1,SSL has EVP_AES_192_CTR) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_256_cbc)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_256_cbc();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_256_CBC,1,SSL has EVP_AES_256_CBC) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_256_cfb1)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_256_cfb1();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_256_CFB1,1,SSL has EVP_AES_256_CFB1) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_256_cfb8)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_256_cfb8();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_256_CFB8,1,SSL has EVP_AES_256_CFB8) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_256_cfb128)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_256_cfb128();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_256_CFB128,1,SSL has EVP_AES_256_CFB128) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_256_ecb)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_256_ecb();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_256_ECB,1,SSL has EVP_AES_256_ECB) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_256_ofb)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_256_ofb();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_256_OFB,1,SSL has EVP_AES_256_OFB) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_256_gcm)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_256_gcm();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_256_GCM,1,SSL has EVP_AES_256_GCM) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])

		AC_MSG_CHECKING(for EVP_aes_256_ccm)
		FW_TRY_LINK([#include <openssl/evp.h>],[EVP_aes_256_ccm();],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_EVP_AES_256_CCM,1,SSL has EVP_AES_256_CCM) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no)])
		...
		AC_MSG_CHECKING(whether SHA512_Init/Update/Final return int)
		FW_TRY_LINK([#include <openssl/sha.h>],[int a=SHA512_Init(0);],[$CPPFLAGS $SSLINCLUDES],[$SSLLIBS],[],[AC_DEFINE(RUDIMENTS_HAS_SHA512_INIT_RETURNING_INT,1,SSL has SHA512_Init/Update/Final returning int) AC_MSG_RESULT(yes)],[AC_MSG_RESULT(no);])
		FW_RESTORE_WERROR
...
extern "C" {
	...
	do
		FW_TRY_LINK([#ifdef RUDIMENTS_HAVE_STDLIB_H
			#include <stdlib.h>
#endif
$CRYPT_H],[crypt_data cd; crypt_r(NULL,NULL,NULL);],[$CPPFLAGS],[$i],[],[HAVE_CRYPT_R="yes"; CRYPTLIB="$i"; AC_DEFINE(RUDIMENTS_HAVE_CRYPT_R,1,Some systems have crypt_r)],[])
