...
#define ucs2literal(___ucs2charstrvar,___charstrvar) \
	char16_t	___ucs2charstrvar##array[sizeof(___charstrvar)/sizeof(char)]; \
	{ \
		const char	*___charstrptr=___charstrvar; \
		char16_t	*___ucs2strptr=___ucs2charstrvar##array; \
		while (*___charstrptr) { \
			*___ucs2strptr=(char16_t)(*___charstrptr); \
			___charstrptr++; \
			___ucs2strptr++; \
		} \
		*___ucs2strptr=(char16_t)'\0'; \
	} \
	const char16_t	*___ucs2charstrvar=___ucs2charstrvar##array
