...
#ifndef RUDIMENTS_AES192_H
#define RUDIMENTS_AES192_H

#include <rudiments/private/aes192includes.h>

/** The aes192 class provides a simple aes192 implementation. */
class RUDIMENTS_DLLSPEC aes192 : public encryption {
	public:
		/** Creates an instance of the aes192 class. */
		aes192();

		/** Deletes this instance of the aes192 class. */
		~aes192();
