...
class RUDIMENTS_DLLSPEC encryption : virtual public object {
	public:
		 ...
		 *  to "usepadding".  Defaults to true.
		 *
		 *  If "usepadding" is false, then the cipher is used as a raw
