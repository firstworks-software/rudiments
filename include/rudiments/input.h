...
class RUDIMENTS_DLLSPEC input : virtual public object {
	public:
		...
		virtual	ssize_t	read(ucs2_t *buffer, size_t length)=0;
		virtual	ssize_t	read(ucs2_t *character)=0;
		...
		virtual	ssize_t	read(wchar_t *character,
						int32_t sec, int32_t usec);
		virtual	ssize_t	read(ucs2_t *buffer, size_t length,
						int32_t sec, int32_t usec);
		virtual	ssize_t	read(ucs2_t *character,
						int32_t sec, int32_t usec);
