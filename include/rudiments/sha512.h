...
#ifndef RUDIMENTS_SHA512_H
#define RUDIMENTS_SHA512_H

#include <rudiments/private/sha512includes.h>

/** The sha512 class provides a simple sha512 implementation. */
class RUDIMENTS_DLLSPEC sha512 : public hash {
	public:
		/** Creates an instance of the sha512 class. */
		sha512();

		/** Deletes this instance of the sha512 class. */
		virtual	~sha512();
		...
		/** Returns true if this platform supports sha512 and false
		 *  otherwise. */
		bool	isSupported();

	#include <rudiments/private/sha512.h>
};
