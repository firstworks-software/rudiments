...
int main(int argc, const char **argv) {
	...
	test("useconds",dt.getMicrosecond()==0);
	...
	test("minutes",dt.getMinute()==54);
	test("seconds",dt.getSecond()==30);
	test("useconds",dt.getMicrosecond()==500);
	...
	test("minutes",dt.getMinute()==54);
	test("seconds",dt.getSecond()==30);
	test("useconds",!dt.getMicrosecond());
	test("month",dt.getMonth()==4);
	test("month name",
		!charstring::compare(dt.getMonthName(),"April"));
	test("month abbr",
	...
	test("addSeconds(1) minutes",dt.getMinute()==54);
	test("addSeconds(1) seconds",dt.getSecond()==30);
	test("addSeconds(1) useconds",dt.getMicrosecond()==501);
	...
	test("addSeconds(-1) minutes",dt.getMinute()==54);
	test("addSeconds(-1) seconds",dt.getSecond()==30);
	test("addSeconds(-1) useconds",dt.getMicrosecond()==500);
	test("addSeconds(-1) month",dt.getMonth()==4);
	test("addSeconds(-1) day of month",dt.getDayOfMonth()==8);
	test("addSeconds(-1) year",dt.getYear()==2016);
	dt.addSeconds(1);
	test("addSeconds(1) hour",dt.getHour()==21);
	test("addSeconds(1) minutes",dt.getMinute()==54);
	test("addSeconds(1) seconds",dt.getSecond()==31);
	test("addSeconds(1) useconds",dt.getMicrosecond()==500);
	test("addSeconds(1) month",dt.getMonth()==4);
	test("addSeconds(1) day of month",dt.getDayOfMonth()==8);
	test("addSeconds(1) year",dt.getYear()==2016);
	...
	test("addMinutes(1) minutes",dt.getMinute()==55);
	test("addMinutes(1) seconds",dt.getSecond()==30);
	test("addMinutes(1) useconds",dt.getMicrosecond()==500);
	...
	dt.addMinutes(-1);
	test("addMinutes(-1) hour",dt.getHour()==21);
	test("addMinutes(-1) minutes",dt.getMinute()==54);
	test("addMinutes(-1) seconds",dt.getSecond()==30);
	test("addMinutes(-1) useconds",dt.getMicrosecond()==500);
	test("addMinutes(-1) month",dt.getMonth()==4);
	test("addMinutes(-1) day of month",dt.getDayOfMonth()==8);
	...
	test("addHours(1) minutes",dt.getMinute()==54);
	test("addHours(1) seconds",dt.getSecond()==30);
	test("addHours(1) useconds",dt.getMicrosecond()==500);
	...
	test("addDays(1) minutes",dt.getMinute()==54);
	test("addDays(1) seconds",dt.getSecond()==30);
	test("addDays(1) useconds",dt.getMicrosecond()==500);
	...
	test("addMonths(1) minutes",dt.getMinute()==54);
	test("addMonths(1) seconds",dt.getSecond()==30);
	test("addMonths(1) useconds",dt.getMicrosecond()==500);
	...
	test("addYears(1) minutes",dt.getMinute()==54);
	test("addYears(1) seconds",dt.getSecond()==30);
	test("addYears(1) useconds",dt.getMicrosecond()==500);
