...
dnl checks to see if -std=c+98 compiler option works or not
dnl if it does, then it sets the variable STDCXX98="-std=c++98"
dnl if it does not , then it sets the variable STDCXX98=""
