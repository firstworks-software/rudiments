...
int main(int argc, const char **argv) {
	...
	if (cmdl.isFound("listener")) {
		listen(nonblockingserver);
	} else if (cmdl.isFound("inet")) {
		inetclient(cmdl.getValue("host"));
	} else if (cmdl.isFound("unix")) {
		unixclient();
	} else {
