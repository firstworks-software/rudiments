...
int main() {
	...
	for (uint64_t i=0; i<LENGTHITERATIONS; i++) {
		len=charstring::getIntegerLength((int64_t)1234567890123456789);
		len=charstring::getIntegerLength((int64_t)123456789012345678);
		len=charstring::getIntegerLength((int64_t)12345678901234567);
		len=charstring::getIntegerLength((int64_t)1234567890123456);
		len=charstring::getIntegerLength((int64_t)123456789012345);
		len=charstring::getIntegerLength((int64_t)12345678901234);
		len=charstring::getIntegerLength((int64_t)1234567890123);
		len=charstring::getIntegerLength((int64_t)123456789012);
		len=charstring::getIntegerLength((int64_t)12345678901);
		len=charstring::getIntegerLength((int64_t)1234567890);
		len=charstring::getIntegerLength((int64_t)123456789);
		len=charstring::getIntegerLength((int64_t)12345678);
		len=charstring::getIntegerLength((int64_t)1234567);
		len=charstring::getIntegerLength((int64_t)123456);
		len=charstring::getIntegerLength((int64_t)12345);
		len=charstring::getIntegerLength((int64_t)1234);
		len=charstring::getIntegerLength((int64_t)123);
		len=charstring::getIntegerLength((int64_t)12);
		len=charstring::getIntegerLength((int64_t)1);
		len=charstring::getIntegerLength((int64_t)-1234567890123456789);
		len=charstring::getIntegerLength((int64_t)-123456789012345678);
		len=charstring::getIntegerLength((int64_t)-12345678901234567);
		len=charstring::getIntegerLength((int64_t)-1234567890123456);
	...
	start.initFromSystemDateTime();
	for (uint64_t i=0; i<LENGTHITERATIONS; i++) {
		len=charstring::getIntegerLength((int32_t)1234567890);
		len=charstring::getIntegerLength((int32_t)123456789);
		len=charstring::getIntegerLength((int32_t)12345678);
		len=charstring::getIntegerLength((int32_t)1234567);
		len=charstring::getIntegerLength((int32_t)123456);
		len=charstring::getIntegerLength((int32_t)12345);
		len=charstring::getIntegerLength((int32_t)1234);
		len=charstring::getIntegerLength((int32_t)123);
		len=charstring::getIntegerLength((int32_t)12);
		len=charstring::getIntegerLength((int32_t)1);
		len=charstring::getIntegerLength((int32_t)-1234567890);
		len=charstring::getIntegerLength((int32_t)-123456789);
		len=charstring::getIntegerLength((int32_t)-12345678);
		len=charstring::getIntegerLength((int32_t)-1234567);
	...
	start.initFromSystemDateTime();
	for (uint64_t i=0; i<LENGTHITERATIONS; i++) {
		len=charstring::getIntegerLength((int16_t)12345);
		len=charstring::getIntegerLength((int16_t)1234);
		len=charstring::getIntegerLength((int16_t)123);
		len=charstring::getIntegerLength((int16_t)12);
		len=charstring::getIntegerLength((int16_t)1);
		len=charstring::getIntegerLength((int16_t)-12345);
		len=charstring::getIntegerLength((int16_t)-1234);
		len=charstring::getIntegerLength((int16_t)-123);
		len=charstring::getIntegerLength((int16_t)-12);
